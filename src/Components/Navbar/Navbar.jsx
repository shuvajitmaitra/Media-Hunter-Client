    ...
    <div className=" w-full  bg-[#468b97]  font-medium fixed z-50">
      <div className=" md:flex items-center max-w-screen-xl mx-auto">
        <div className="navbar">
          ...
          <label className="swap navbar-end md:hidden swap-rotate">
        ...
        <div className="navbar-end w-full md:max-w-max flex justify-center gap-3 ">
          <label className="swap swap-rotate w-0 md:w-auto invisible md:visible ">
            {/* this hidden checkbox controls the state */}
            <input
              type="checkbox"
              onChange={handleToggle}
          ...
          {user ? (
            <span className="flex w-full items-center gap-3 py-3 font-medium ">
              <img
                src={user.photoURL}
